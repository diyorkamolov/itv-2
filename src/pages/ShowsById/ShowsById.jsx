            ...
            {show && (
                <Box>
                    ...
                    <Box sx={{ marginLeft: '13%', borderRadius: '10px', marginTop: '30px' }}>
                        ...
                        <Box sx={{ marginTop: '-37%' }}>
                            <Typography variant="h7" sx={{ marginLeft: "26%", width: '370px', color: 'rgba(255, 255, 255, 0.5)' }}>{show.genre}</Typography>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', mt: 35 }}>
                            ...
                            {show.kadr.map((snapshot, index) => (
                                <img key={index} src={snapshot} alt={`Snapshot ${index}`} style={{ marginTop: "3%",display: 'flex', width: '19%', height: "19vh", margin: '16px', borderRadius: '14px', boxShadow: '0px 2px 4px rgba(0, 0, 0, 0.1)' }} />
                            ))}
                        </Box>
